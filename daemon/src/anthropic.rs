        ...
        json!([
            ...
            },
            {
                ...
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "goal": {"type": "string", "description": "The objective to run when the mission fires, e.g. 'review my deadlines and flag anything slipping'."},
                        "schedule": {"type": "string", "description": "The trigger in plain words. TIME: 'daily', 'daily at 7am', 'every 6 hours', 'hourly', or 'on <signal>' (e.g. 'on mail'). TRIPWIRE (condition): 'free disk below 10%', 'memory above 90%', 'unread above 5', or 'calendar event within 15m'. Ambiguous phrasing falls back to at-most-daily."},
